...
interface TermsContract {
  ...
  function registerRepayment(address debtor, string termsParameters, uint256 unitsOfRepayment, address tokenAddress) public;
  ...
  function getExpectedRepaymentValue(address debtor, string termsParameters, uint256 blockNumber) public view returns (uint256);
  ...
  function getValueRepaid(address debtor, string termsParameters, uint256 blockNumber) public view returns (uint256);
}
