...
class DummyTokenRegistryContract extends base_contract_1.BaseContract {
    ...
    static getArtifactsData(web3) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const artifact = yield fs.readFile("build/contracts/DummyTokenRegistry.json", "utf8");
...
//# sourceMappingURL=dummy_token_registry.js.map